...
public class CalServiceProxy implements com.sneha.service.CalService {
  private String _endpoint = null;
  private com.sneha.service.CalService calService = null;
  ...
  private void _initCalServiceProxy() {
    try {
      calService = (new com.sneha.service.CalServiceServiceLocator()).getCalService();
      if (calService != null) {
        if (_endpoint != null)
  ...
  public com.sneha.service.CalService getCalService() {
    if (calService == null)
      _initCalServiceProxy();
    return calService;
  }

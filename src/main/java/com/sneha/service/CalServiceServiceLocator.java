...
public class CalServiceServiceLocator extends org.apache.axis.client.Service implements com.sneha.service.CalServiceService {
    ...
    private java.lang.String CalService_address = "http://localhost:8080/Lab1/services/CalService";
    ...
    public com.sneha.service.CalService getCalService() throws javax.xml.rpc.ServiceException {
    ...
    public com.sneha.service.CalService getCalService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.sneha.service.CalServiceSoapBindingStub _stub = new com.sneha.service.CalServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.sneha.service.CalService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.sneha.service.CalServiceSoapBindingStub _stub = new com.sneha.service.CalServiceSoapBindingStub(new java.net.URL(CalService_address), this);
                _stub.setPortName(getCalServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.sneha.com", "CalServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.sneha.com", "CalService"));
        }
